...
public class MainActivity extends AppCompatActivity  {
    ...
    private void testWifi() {
        ...
        tmp.add(new Wifi("00:26:cb:a0:aa:c1", 72.0f, 71.0f, 71.2f, 0f));
        tmp.add(new Wifi("c8:b3:73:4b:01:c9", 85.0f, 83.0f, 84.2f, 0f));
        tmp.add(new Wifi("00:26:cb:4d:d9:41", 79.0f, 71.0f, 75.4f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:cf:b3", 75.0f, 69.0f, 70.8f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d2:a4", 57.0f, 47.0f, 52.0f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:3c", 73.0f, 56.0f, 61.2f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:36", 82.0f, 81.0f, 81.2f, 0f));
        tmp.add(new Wifi("d0:57:4c:cb:4a:71", 77.0f, 77.0f, 77.0f, 0f));
        tmp.add(new Wifi("fe:52:8d:c6:63:5a", 86.0f, 86.0f, 86.0f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c0", 71.0f, 71.0f, 71.0f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:2d", 79.0f, 78.0f, 78.8f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:50", 65.0f, 63.0f, 64.5f, 0f));
        tmp.add(new Wifi("00:26:cb:4d:d9:40", 79.0f, 73.0f, 74.5f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:0c", 71.0f, 66.0f, 67.5f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:51", 65.0f, 64.0f, 64.7f, 0f));
        tmp.add(new Wifi("c8:b3:73:4b:01:ca", 85.0f, 84.0f, 84.7f, 0f));
        tmp.add(new Wifi("30:b5:c2:df:fd:60", 88.0f, 81.0f, 84.3f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:72", 89.0f, 89.0f, 89.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:07:f0", 79.0f, 79.0f, 79.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:07:f1", 79.0f, 78.0f, 78.7f, 0f));
        tmp.add(new Wifi("00:37:b7:64:c3:66", 90.0f, 90.0f, 90.0f, 0f));
        ...
        tmp.add(new Wifi("00:26:cb:a0:aa:c1", 69.0f, 65.0f, 66.8f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:cf:b3", 85.0f, 79.0f, 81.6f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d2:a4", 64.0f, 51.0f, 58.6f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:3c", 82.0f, 69.0f, 76.8f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:0c", 64.0f, 64.0f, 64.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:70", 87.0f, 74.0f, 79.8f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:71", 89.0f, 72.0f, 82.0f, 0f));
        tmp.add(new Wifi("c8:b3:73:4b:01:c9", 92.0f, 92.0f, 92.0f, 0f));
        tmp.add(new Wifi("10:9a:dd:b5:2a:3f", 88.0f, 85.0f, 86.6f, 0f));
        tmp.add(new Wifi("00:26:cb:4d:d9:41", 79.0f, 75.0f, 76.6f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:2d", 86.0f, 85.0f, 85.2f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:72", 87.0f, 74.0f, 79.4f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:73", 80.0f, 80.0f, 80.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:07:f0", 73.0f, 71.0f, 71.4f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:50", 79.0f, 69.0f, 74.4f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:07:f1", 81.0f, 71.0f, 77.8f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:51", 79.0f, 69.0f, 73.8f, 0f));
        tmp.add(new Wifi("00:26:cb:4d:d9:40", 77.0f, 77.0f, 77.0f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c0", 77.0f, 67.0f, 70.3f, 0f));
        ...
        tmp = new ArrayList<Wifi>();
        tmp.add(new Wifi("00:26:cb:4e:0e:e1", 53.0f, 33.0f, 37.8f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d2:a4", 82.0f, 82.0f, 82.0f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c1", 85.0f, 81.0f, 83.2f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e0", 35.0f, 32.0f, 33.2f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:0c", 88.0f, 88.0f, 88.0f, 0f));
        ...
        tmp = new ArrayList<Wifi>();
        tmp.add(new Wifi("00:26:cb:4e:0e:e1", 64.0f, 54.0f, 57.0f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c1", 84.0f, 63.0f, 71.4f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e0", 61.0f, 32.0f, 52.4f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:0c", 79.0f, 78.0f, 78.6f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:3c", 81.0f, 80.0f, 80.2f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:70", 88.0f, 88.0f, 88.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:72", 91.0f, 91.0f, 91.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:71", 91.0f, 91.0f, 91.0f, 0f));
        tmp.add(new Wifi("24:b6:57:8d:34:41", 81.0f, 79.0f, 80.6f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:50", 69.0f, 69.0f, 69.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:04:51", 69.0f, 66.0f, 67.8f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c0", 75.0f, 62.0f, 71.2f, 0f));
        ...
        tmp = new ArrayList<Wifi>();
        tmp.add(new Wifi("00:26:cb:a0:aa:c1", 86.0f, 86.0f, 86.0f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:3c", 84.0f, 80.0f, 82.4f, 0f));
        tmp.add(new Wifi("00:26:cb:a0:aa:c0", 69.0f, 69.0f, 69.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0c:a1", 76.0f, 68.0f, 71.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0c:a0", 76.0f, 69.0f, 71.2f, 0f));
        tmp.add(new Wifi("10:9a:dd:b5:2a:3f", 90.0f, 88.0f, 88.4f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:70", 87.0f, 85.0f, 85.8f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:72", 89.0f, 87.0f, 87.8f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:71", 85.0f, 84.0f, 84.4f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:0c", 84.0f, 80.0f, 82.4f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d2:a4", 78.0f, 70.0f, 76.0f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e0", 77.0f, 76.0f, 76.3f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e1", 77.0f, 76.0f, 76.7f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:2d", 84.0f, 84.0f, 84.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:73", 86.0f, 86.0f, 86.0f, 0f));
        ...
        tmp = new ArrayList<Wifi>();
        tmp.add(new Wifi("00:26:cb:4e:0c:a1", 85.0f, 77.0f, 81.8f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e1", 60.0f, 52.0f, 54.8f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d2:a4", 80.0f, 62.0f, 73.0f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:cf:b3", 89.0f, 81.0f, 83.6f, 0f));
        tmp.add(new Wifi("00:0c:e6:00:d1:2d", 82.0f, 74.0f, 78.8f, 0f));
        tmp.add(new Wifi("00:26:cb:4e:0e:e0", 61.0f, 55.0f, 58.8f, 0f));
        tmp.add(new Wifi("30:b5:c2:df:fd:60", 87.0f, 84.0f, 86.0f, 0f));
        tmp.add(new Wifi("f8:e9:03:cb:00:a0", 87.0f, 87.0f, 87.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:74", 87.0f, 87.0f, 87.0f, 0f));
        tmp.add(new Wifi("d4:6d:50:f2:c7:73", 90.0f, 85.0f, 87.5f, 0f));
